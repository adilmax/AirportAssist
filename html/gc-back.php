<?php
$title = "Airport Assistance Gift card";
                ...
                <form action="" method="post" class="gc_form">
                    ...
                    <div class="in-wrapper">
                        <div class="row">
                            <div class="col-md-12 gc_pt10">
                                ...
                                <div class="col-md-2">
                                    <img class="gc-img" src="giftcard/giftcard_2.jpg">
                                </div>
                                <div class="col-md-2">
                    ...
                    <div class="in-wrapper">
                        ...
                        <div class="select-amount">
                            ...
                            <button id="amount-25" class="btn btn-card btn-small btn-border amount" type="button"
                                    value="25">$25
                            </button></span>
                            <span class="amount_span">
                            <button id="amount-50" class="btn btn-card btn-small btn-border amount" type="button"
                                    value="50">$50
                            </button></span>
                            <span class="amount_span">
                            <button id="amount-100" class="btn btn-card btn-small btn-border amount" type="button"
                                    value="100">$100
                            </button></span>
                            <span class="amount200_span">
                            <button id="amount-200" class="btn btn-card btn-small btn-border amount" type="button"
                                    value="200">$200
                            </button></span>
                                </div>
                                <div class="col-md-4"
                            <span class="selected_amount">
                            $ <input type="text" name="giftAmount" class="input-sm place_holder" placeholder="Amount"
...
<script type="text/javascript">
    ...
    $("#giftAmount").change(function () {
        ...
        if (giftAmount >=25 && giftAmount<=500) {
            ...
            $("#amountError").html("Enter an amount between $25 - $500.");
