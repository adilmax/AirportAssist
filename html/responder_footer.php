...
<script  type="text/javascript">
   $(function() {
        ...
        if (height_diff > 0) {
            $('#footer').css('padding-top', height_diff);
        }
    });
</script>
<script type="text/javascript">
...
$("#twittersharer").click(function(){
    ...
    var url = "https://twitter.com/share?url=https://www.murgencyairportassistance.com&via=MUrgency&hashtags=Airport Assistance\n\
