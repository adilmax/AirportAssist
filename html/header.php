...
<head>
    ...
    <noscript><img height="1" width="1" style="display:none"
                   src="https://www.facebook.com/tr?id=1067364606643550&ev=PageView&noscript=1"/></noscript>
...
switch ($title) {
    ...
    case "Our Services":
        ...
        break;
    case "Home":
        $login = 'style="background-color: #c3262f;"';
        $logincolor = 'style="color:white;"';
        break;
    case "Blog":
...
<nav role="navigation" class="navbar navbar-fixed-top">
    ...
    <div id="navbarCollapse" class="collapse navbar-collapse">
        <ul class="nav navbar-nav navbar-right mobile_nav_color" style="padding-right:30px;">
            ...
            <li <?= $airport ?>><a href="airportserved" <?= $airportColour ?>>Airports Served</a></li>
            <li <?= $faq ?>><a href="faq" <?= $faqcolor ?>>FAQs</a></li>
            <li><a href="traveltips" <?= $blogcolor ?>>Blog</a></li>
            <? if ($serverName == "murgencyairportassistance.com") { ?>
                <!--<li <?= $payment ?>><a href="payment" <?= $paymentcolor ?>>Payment</a></li>-->
            <? } ?>
            <? if ($isCity) { ?>
                <li><a href="https://en.wikipedia.org/wiki/Dubai_International_Airport" class="white" target="_blank">Airport
                        Info</a></li>
            <? } ?>
            <li <?= $contactus ?>><a href="contact" <?= $contactusColour ?>>Contact Us</a></li>
            <li <?= $login ?> style="margin-right: 10px;"><a href="login" <?= $logincolor ?>>Sign In</a></li>
            <li class="dropdown" <?= $assistant; ?>>
                <a class="dropdown-toggle" data-toggle="dropdown" href="#" <?= $assistantColor; ?>>Partner with us <span
                        class="caret"></span></a>
                <ul class="dropdown-menu">
                    <li><a href="http://www.murgencyairportassistance.com/corporateregistration" class=" white">Corporate</a>
                    </li>
...
<li class="dropdown" id="AirportAssistFeatures">
                <a class="dropdown-toggle white" data-toggle="dropdown" href="#">Features<span
                            class="caret"></span></a>
                <ul class="dropdown-menu">
                    <li>
                        <a href="flightdetails" class=" white">Flight Tracker</a>
                    </li>
                    <!-- <li>
                        <a href="" class="white">Wifi Locator</a>
                    </li> -->
                    <li>
                        <a href="checkweather" class="white">Weather</a>
                    </li>
                    <li>
                        <a href="currencyconverter" class="white">Currency Converter</a>
                    </li>
                </ul>
            </li>
         <li style="background-color: #c3262f;">
                <a href="http://www.murgencyairportassistance.com/egiftcard" class=" white">Gift Card</a>
            </li>
