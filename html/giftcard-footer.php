...
<footer style="margin-bottom: 10px;" id="footer">
    <div class="row stamp-color padding-left">
        ...
        <div class="media-body">
            <h2 class="media-heading white stamp-top">We Ensure Swift, Smooth and Safe Passage Through Airport</h2>
        </div>
        </div>
        </div>-->
        <div class="col-lg-2 col-md-2 col-xs-4">
            ...
            <div class="col-lg-10 col-md-10 col-xs-8">
                <h2 class="xs-font white stamp-top">We Ensure Swift, Smooth And Safe Passage Through Airport</h2>
            </div>
            ...
            <div class="row media-icom">
                ...
                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-8 image-padding" >
                    ...
                    <button class="btn btn-mod btn-subscribe" data-toggle="modal" data-target="#overlay_footer">
                     ...
                     <button class="btn btn-mod" data-toggle="modal" data-target="#terms">
                        Terms 
                    </button>
                </div>
                <div class="col-lg-1 col-md-1 col-sm-1 col-xs-1"></div>
    ...
    <div class="modal-dialog">
      ...
      <div class="modal-content" style="width:800px;">
        ...
        <div class="modal-body">
          ...
          <li>You must redeem the Gift Card Voucher in one booking only. Any amount not redeemed in that booking will be lost and no credit will remain.</li>
          <li>The Gift Card is redeemable based on inputting the Gift Code Card in the link which is sent once the service is confirmed. </li>
          <li>Any additional service booked in conjunction with the use of this Voucher will be subject to standard booking conditions.</li>
          <li>Gift Card Vouchers are valid for 12 months (365 days) from the Gift Card Voucher issue date. The validity of the Gift Card Vouchers cannot be extended</li>
          </ul>
        </div>
...
<script src="js/bootstrap-dropdown-checkbox.min.js"
