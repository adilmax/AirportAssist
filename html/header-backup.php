...
<noscript><img height="1" width="1" style="display:none" src="https://www.facebook.com/tr?id=1067364606643550&ev=PageView&noscript=1"/></noscript>
        ...
        <!-- Brand and toggle get grouped for better mobile display -->
            ...
            <div id="navbarCollapse" class="collapse navbar-collapse">
                <ul class="nav navbar-nav navbar-right mobile_nav_color" style="padding-right:30px;">
                    ...
                    <? }?>
                    <?if($isCity){?>
                    <li><a href="https://en.wikipedia.org/wiki/Dubai_International_Airport" class="white" target="_blank">Airport Info</a></li>   
                    <?}?>                    
                    ...
                    <li class="dropdown" <?=$assistant;?>>
                        <a class="dropdown-toggle" data-toggle="dropdown" href="#" <?=$assistantColor;?>>Work With Us <span class="caret"></span></a>
                        <ul class="dropdown-menu">
