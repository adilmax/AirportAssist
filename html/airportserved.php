<?
$title = "Airport Assistance Worldwide | Services in 625 Airports | Dubai | London | Hong Kong | Ground handling globally";
$titleName = "Airports Served";
$metaDesc = "Be it London, Dubai, Hong Kong, or Australia, we provide airport assistance & ground handling services in 625 airports in 195 countries across the globe. Find your city here.";
...
<div class="row padding-left-airport-served">
    <div class="container title_top">
        ...
        <div class='ul_bottom'>
            ...
            <div class="row">
                <div class="col-xs-8 col-sm-6 col-md-6 form-group searchpadding">
                ...
                <div class="col-xs-3 col-sm-4 col-md-6 nopadding">
