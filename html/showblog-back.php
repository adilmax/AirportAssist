                ...
                <? if(count($blog)> 0){ ?>   
                    <?  for ($i = 0; $i < count($blog); $i++) { 
                        ...
                        <div class="row show_image">                            
                            ...
                            <div class="col-lg-8">
                                <div>
                                    <h3 class="showblog"><a href="blogcomment.php?id=<?=$objectID?>"><?= $blog[$i]->get('title')?></a></h3>                                
                                </div>
                                <p class="showblog"><b>Publish on:-&nbsp;<?=$blog[$i]->getCreatedAt()->format('d-M-Y');?></b></p>
                                <div>
								<p class="showblog content"> <?=substr(strip_tags($blog[$i]->get('content')),0,200);?>..</p>
								
                                    <div align="right"><a href="blogcomment.php?id=<?=$objectID?>">Read More...</a></div>
                                </div>
                            </div>                             
                      </div>
                    <? }?>
        ...
        <div class="col-lg-3 margin_top">
            ...
            <? } ?>
             ...
             <div class="form-group">
                <div class="col-lg-12 margin_blog">Category</div>
                <div class="col-lg-12 col-lg-offset-1">                    
                 <select name="category" id="category" class="form-control field_size place_holder">
