...
/*define('STRIPE_PRIVATE_KEY', 'sk_live_4SevPXcrsRsasnZ8jkYPq9ol');
define('STRIPE_PUBLIC_KEY', 'pk_live_4SevjbFhjzxBlzFfpPqElooS');*/


define('STRIPE_PRIVATE_KEY', 'sk_test_giT9XFsYTmEydkzLD1EAT0ap');
define('STRIPE_PUBLIC_KEY', 'pk_test_LDQr8VA3tRLdllFwoFOzTTZk');