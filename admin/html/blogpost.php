        ...
        <form action="" method="post" class="form-horizontal form_top" id="blog-form" enctype="multipart/form-data">
            ...
            <div class="col-lg-12 col-md-12 col-xs-12">
                ...
                <div class="form-group">
                    <div  class="col-lg-2 control-label field_size">Section:<span class="asteric">*</span></div>
                    <div class="col-lg-10">
                     <select name="section" id="section" class="form-control field_size place_holder" required="true">
                    <option value="">Select value</option>
                    <?php foreach($blogSection as $key=>$value){?>
               ...
               <div class="form-group">
                ...
                <div class="form-group">
                    <div  class="col-lg-2 control-label field_size">Category:<span class="asteric">*</span></div>
                    <div class="col-lg-10">
                     <select name="category" id="category" class="form-control field_size place_holder" required="true">
                    <option value="">Select value</option>
                    <?php foreach($blogpostCategory as $key=>$value){?>
                ...
                <div class="form-group">
                    ...
                    <div class="col-lg-10">
                        ...
                        <div>Note:Please upload image with size 900X300 about 900kb and type:JPEG/PNG.  </div>
                    </div>
...
<script  type="text/javascript">
                    ...
                    if ((file = this.files[0])) {                       
                        ...
                        img.onload = function() {
                            if(this.width >= 900 && this.height >= 300){
                                ...
                                if(filesize > 900){
                                    $("#image_error").html("Maximum file size should be 900kb");
                                    $("#image_error").show();                                
                                    ...
                                    $("#image_error").html("Minimum width and height should be 900 / 300");
                                    $("#image_error").show();                               
                                    $('#submit').attr('disabled','disabled');
                            }                          
                        };                      
    ...
    $('#section').change( function() {       
        ...
        $('#category').append($('<option>', { value : '' }).text('Select Value')); 
        $.post("blogcategory.php",{section:section},function(data){
        var dataArray = jQuery.parseJSON(data);        
        $('#category').find('option:not(:first)').remove();
        $.each(dataArray, function(key, value) {            
        $('#category').append($('<option>', { value : key }).text(value)); 
          });          
        });
    });
