    ...
    <div class="container margin_top">
            ...
            <div class="col-lg-12 col-md-12 col-xs-12 registration_right_contant_bgcolor" >
                <div class="text-center">
                    <h3>YOUR SERVICE REQUEST HAS BEEN SUCCESSFULLY PLACED</h3>
                </div>
                <div class="text-center margin_top_welcome">
                    <h3>Thank you for Choosing MUrgency Airport Assistance</h3> 
                </div>
                <div class="text-center margin_top_welcome">
                    Please check your email for order details.
                    <p> If you haven't received the order details please check your spam mail,</p>
